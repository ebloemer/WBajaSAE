#include <Arduino.h>
#line 1 "C:\\Users\\dying\\OneDrive - The University of Western Ontario\\Western Baja\\Github Code\\WBajaSAE\\ecvtBruteForce\\ecvtBruteForce.ino"
...
#line 103 "C:\\Users\\dying\\OneDrive - The University of Western Ontario\\Western Baja\\Github Code\\WBajaSAE\\ecvtBruteForce\\ecvtBruteForce.ino"
void setup();
#line 141 "C:\\Users\\dying\\OneDrive - The University of Western Ontario\\Western Baja\\Github Code\\WBajaSAE\\ecvtBruteForce\\ecvtBruteForce.ino"
void loop();
#line 238 "C:\\Users\\dying\\OneDrive - The University of Western Ontario\\Western Baja\\Github Code\\WBajaSAE\\ecvtBruteForce\\ecvtBruteForce.ino"
void setCommandHelix();
#line 256 "C:\\Users\\dying\\OneDrive - The University of Western Ontario\\Western Baja\\Github Code\\WBajaSAE\\ecvtBruteForce\\ecvtBruteForce.ino"
...
void openCVT(int revSpeed) {
	...
	if(helixPos > helixMin) {
		if(revDirection == 0 || revDirection == 2) {
...
void closeCVT(int fwdSpeed) {
	...
	if(helixPos < helixMax){
		...
		if(revDirection == 1 || revDirection == 2) {
...
void potRead() {
	...
	throttlePos = map(rawThrottle, 0, 4095, 0, 100);    // Map the raw throttle value to a percentage
