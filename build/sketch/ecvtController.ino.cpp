#include <Arduino.h>
#line 1 "C:\\Users\\dying\\OneDrive - The University of Western Ontario\\Western Baja\\Github Code\\WBajaSAE\\ecvtController\\ecvtController.ino"
...
#define motorEnable 32
#define motorClose 25
#define motorOpen 26
...
#line 152 "C:\\Users\\dying\\OneDrive - The University of Western Ontario\\Western Baja\\Github Code\\WBajaSAE\\ecvtController\\ecvtController.ino"
void setup();
#line 198 "C:\\Users\\dying\\OneDrive - The University of Western Ontario\\Western Baja\\Github Code\\WBajaSAE\\ecvtController\\ecvtController.ino"
void loop();
#line 152 "C:\\Users\\dying\\OneDrive - The University of Western Ontario\\Western Baja\\Github Code\\WBajaSAE\\ecvtController\\ecvtController.ino"
void setup() {
...
void exportOnboardDiag() {
	...
	Onboard.print(digitalRead(motorClose));;
	Onboard.print(",");

	Onboard.print("Rev:"); // 0-1
	Onboard.print(digitalRead(motorOpen));
	Onboard.print(",");
...
void exportBluetoothDiag(){
	...
	SerialBT.print(digitalRead(motorClose));
	SerialBT.print(",");

	SerialBT.print("Rev:"); // 0-1
	SerialBT.print(digitalRead(motorOpen));
	SerialBT.print(",");
